 ...
 * @author ahhun
 */
public class Tbl_CollaboratorDAO implements Serializable{
    public List<Tbl_CollaboratorDTO> getProductivityOfCollaborator() throws NamingException, SQLException {
        Connection con = null;
        ...
        try {
            ...
            if(con != null) {
                String sql = "SELECT StaffID, Name, Username, [Status], COUNT(a.ArticleID) "
                        ...
                        "	tbl_Staff s\n" +
                        "	FULL OUTER JOIN\n" +
                        "	tbl_Article a ON StaffID = a.AuthorID\n" +
                        "	FULL OUTER JOIN\n" +
                ...
                List<Tbl_CollaboratorDTO> lists = null;
                String staffID = null;
                String name = null;
                String username = null;
                int numOfAcceptedPosts = 0;
                int numOfPendingPosts = 0;
                ...
                while (rs.next()) {
                    ...
                    if (staffID == null || !staffID.equals(newStaffID)) {
                        if (staffID != null) {
                            double avgTime = (numOfAcceptedPosts + numOfPendingPosts + numOfRejectedPosts) * 24.0 / 30;
                            ...
                            lists.add(new Tbl_CollaboratorDTO(staffID, name, username, numOfAcceptedPosts,
                                    numOfRejectedPosts, numOfPendingPosts, avgTime, avgViews, avgCmts));
                    ...
                    if (status != null)
                        switch (status) {
                            ...
                            case "Rejected":
                                ...
                                break;
                            default:
                                numOfPendingPosts += rs.getInt("numberOfPosts");
                                break;
                        }
                }
